 ...
 * <!-- end-user-doc -->
 * @see tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.HypoMethodPackage#getExpression()
 * @model
 * @generated
 */
public enum Expression implements Enumerator
{
  /**
   ...
   * @generated
   */
  public static final List<Expression> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Expression</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static Expression get(String literal)
  {
  ...
  /**
   * Returns the '<em><b>Expression</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private Expression(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
