 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.ControlVariablesImpl#getControlName <em>Control Name</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.ControlVariablesImpl#getControlType <em>Control Type</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.ControlVariablesImpl#getControlValue <em>Control Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlVariablesImpl extends MinimalEObjectImpl.Container implements ControlVariables
{
  ...
  {
    return HypoMethodPackage.Literals.CONTROL_VARIABLES;
  }
  ...
  public void setControlName(String newControlName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.CONTROL_VARIABLES__CONTROL_NAME, oldControlName, controlName));
  }
  ...
  public void setControlType(VariableType newControlType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.CONTROL_VARIABLES__CONTROL_TYPE, oldControlType, controlType));
  }
  ...
  public NotificationChain basicSetControlValue(Values newControlValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HypoMethodPackage.CONTROL_VARIABLES__CONTROL_VALUE, oldControlValue, newControlValue);
  ...
  public void setControlValue(Values newControlValue)
  {
    if (newControlValue != controlValue)
    {
      ...
      if (controlValue != null)
        msgs = ((InternalEObject)controlValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.CONTROL_VARIABLES__CONTROL_VALUE, null, msgs);
      if (newControlValue != null)
        msgs = ((InternalEObject)newControlValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.CONTROL_VARIABLES__CONTROL_VALUE, null, msgs);
      msgs = basicSetControlValue(newControlValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.CONTROL_VARIABLES__CONTROL_VALUE, newControlValue, newControlValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HypoMethodPackage.CONTROL_VARIABLES__CONTROL_VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.CONTROL_VARIABLES__CONTROL_NAME:
        return getControlName();
      case HypoMethodPackage.CONTROL_VARIABLES__CONTROL_TYPE:
