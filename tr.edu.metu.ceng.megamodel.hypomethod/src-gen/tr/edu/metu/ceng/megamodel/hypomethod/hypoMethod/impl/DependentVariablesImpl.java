 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.DependentVariablesImpl#getResponseName <em>Response Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependentVariablesImpl extends MinimalEObjectImpl.Container implements DependentVariables
{
  ...
  {
    return HypoMethodPackage.Literals.DEPENDENT_VARIABLES;
  }
  ...
  public NotificationChain basicSetResponseName(Response newResponseName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HypoMethodPackage.DEPENDENT_VARIABLES__RESPONSE_NAME, oldResponseName, newResponseName);
  ...
  public void setResponseName(Response newResponseName)
  {
    if (newResponseName != responseName)
    {
      ...
      if (responseName != null)
        msgs = ((InternalEObject)responseName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.DEPENDENT_VARIABLES__RESPONSE_NAME, null, msgs);
      if (newResponseName != null)
        msgs = ((InternalEObject)newResponseName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.DEPENDENT_VARIABLES__RESPONSE_NAME, null, msgs);
      msgs = basicSetResponseName(newResponseName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.DEPENDENT_VARIABLES__RESPONSE_NAME, newResponseName, newResponseName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HypoMethodPackage.DEPENDENT_VARIABLES__RESPONSE_NAME:
