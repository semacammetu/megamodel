 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GoalsImpl#getObjOfStudy <em>Obj Of Study</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GoalsImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GoalsImpl#getFocus <em>Focus</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GoalsImpl#getViewPoint <em>View Point</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GoalsImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GoalsImpl extends ExperimentOntologyImpl implements Goals
{
  ...
  {
    return HypoMethodPackage.Literals.GOALS;
  }
  ...
  public void setObjOfStudy(String newObjOfStudy)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GOALS__OBJ_OF_STUDY, oldObjOfStudy, objOfStudy));
  }
  ...
  public void setPurpose(String newPurpose)
  {
    ...
    purpose = newPurpose;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GOALS__PURPOSE, oldPurpose, purpose));
  }
  ...
  public void setFocus(String newFocus)
  {
    ...
    focus = newFocus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GOALS__FOCUS, oldFocus, focus));
  }
  ...
  public void setViewPoint(String newViewPoint)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GOALS__VIEW_POINT, oldViewPoint, viewPoint));
  }
  ...
  public void setContext(String newContext)
  {
    ...
    context = newContext;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GOALS__CONTEXT, oldContext, context));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.GOALS__OBJ_OF_STUDY:
        return getObjOfStudy();
      case HypoMethodPackage.GOALS__PURPOSE:
        return getPurpose();
      case HypoMethodPackage.GOALS__FOCUS:
        return getFocus();
      case HypoMethodPackage.GOALS__VIEW_POINT:
        return getViewPoint();
      case HypoMethodPackage.GOALS__CONTEXT:
        return getContext();
    }
