 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GuardConditionImpl#getGd <em>Gd</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GuardConditionImpl#getCondition1 <em>Condition1</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GuardConditionImpl#getLink <em>Link</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.GuardConditionImpl#getCondition2 <em>Condition2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuardConditionImpl extends MinimalEObjectImpl.Container implements GuardCondition
{
  ...
  {
    return HypoMethodPackage.Literals.GUARD_CONDITION;
  }
  ...
  public void setGd(String newGd)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GUARD_CONDITION__GD, oldGd, gd));
  }
  ...
  public void setCondition1(String newCondition1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GUARD_CONDITION__CONDITION1, oldCondition1, condition1));
  }
  ...
  public void setLink(String newLink)
  {
    ...
    link = newLink;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GUARD_CONDITION__LINK, oldLink, link));
  }
  ...
  public void setCondition2(String newCondition2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.GUARD_CONDITION__CONDITION2, oldCondition2, condition2));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.GUARD_CONDITION__GD:
        return getGd();
      case HypoMethodPackage.GUARD_CONDITION__CONDITION1:
        return getCondition1();
      case HypoMethodPackage.GUARD_CONDITION__LINK:
        return getLink();
      case HypoMethodPackage.GUARD_CONDITION__CONDITION2:
