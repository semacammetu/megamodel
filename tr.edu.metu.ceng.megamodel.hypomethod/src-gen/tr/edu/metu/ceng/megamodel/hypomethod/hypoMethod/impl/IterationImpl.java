 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.IterationImpl#getIterations <em>Iterations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IterationImpl extends MinimalEObjectImpl.Container implements Iteration
{
  ...
  {
    return HypoMethodPackage.Literals.ITERATION;
  }
  ...
  public void setIterations(int newIterations)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.ITERATION__ITERATIONS, oldIterations, iterations));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.ITERATION__ITERATIONS:
