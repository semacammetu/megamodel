 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.MechHypothesisImpl#getMName <em>MName</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.MechHypothesisImpl#getAssoMech <em>Asso Mech</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.MechHypothesisImpl#getMechanisticHypothesis <em>Mechanistic Hypothesis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MechHypothesisImpl extends MinimalEObjectImpl.Container implements MechHypothesis
{
  ...
  {
    return HypoMethodPackage.Literals.MECH_HYPOTHESIS;
  }
  ...
  public void setMName(String newMName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.MECH_HYPOTHESIS__MNAME, oldMName, mName));
  }
  ...
  public EList<TemporalPattern> getAssoMech()
  {
    if (assoMech == null)
    {
      assoMech = new EObjectContainmentEList<TemporalPattern>(TemporalPattern.class, this, HypoMethodPackage.MECH_HYPOTHESIS__ASSO_MECH);
    }
    return assoMech;
  }
  ...
  public void setMechanisticHypothesis(String newMechanisticHypothesis)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.MECH_HYPOTHESIS__MECHANISTIC_HYPOTHESIS, oldMechanisticHypothesis, mechanisticHypothesis));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HypoMethodPackage.MECH_HYPOTHESIS__ASSO_MECH:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.MECH_HYPOTHESIS__MNAME:
        return getMName();
      case HypoMethodPackage.MECH_HYPOTHESIS__ASSO_MECH:
        return getAssoMech();
      case HypoMethodPackage.MECH_HYPOTHESIS__MECHANISTIC_HYPOTHESIS:
