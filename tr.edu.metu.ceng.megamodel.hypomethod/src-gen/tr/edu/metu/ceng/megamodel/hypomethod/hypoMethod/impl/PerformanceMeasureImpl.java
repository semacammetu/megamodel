 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.PerformanceMeasureImpl#getExpectedResponse <em>Expected Response</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.PerformanceMeasureImpl#getEr <em>Er</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.PerformanceMeasureImpl#getStd <em>Std</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PerformanceMeasureImpl extends MinimalEObjectImpl.Container implements PerformanceMeasure
{
  ...
  {
    return HypoMethodPackage.Literals.PERFORMANCE_MEASURE;
  }
  ...
  public void setExpectedResponse(String newExpectedResponse)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.PERFORMANCE_MEASURE__EXPECTED_RESPONSE, oldExpectedResponse, expectedResponse));
  }
  ...
  public void setEr(String newEr)
  {
    ...
    er = newEr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.PERFORMANCE_MEASURE__ER, oldEr, er));
  }
  ...
  public void setStd(String newStd)
  {
    ...
    std = newStd;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.PERFORMANCE_MEASURE__STD, oldStd, std));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.PERFORMANCE_MEASURE__EXPECTED_RESPONSE:
        return getExpectedResponse();
      case HypoMethodPackage.PERFORMANCE_MEASURE__ER:
        return getEr();
      case HypoMethodPackage.PERFORMANCE_MEASURE__STD:
        return getStd();
    }
