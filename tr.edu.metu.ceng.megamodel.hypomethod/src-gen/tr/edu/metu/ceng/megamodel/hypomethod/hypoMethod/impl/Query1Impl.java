 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getFactor <em>Factor</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getControl <em>Control</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getX <em>X</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getStart1 <em>Start1</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getEnd1 <em>End1</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getResponse <em>Response</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getY <em>Y</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getStart2 <em>Start2</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query1Impl#getEnd2 <em>End2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Query1Impl extends RelationalQueryImpl implements Query1
{
  ...
  {
    return HypoMethodPackage.Literals.QUERY1;
  }
  ...
  public void setFactor(String newFactor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__FACTOR, oldFactor, factor));
  }
  ...
  public void setControl(String newControl)
  {
    ...
    control = newControl;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__CONTROL, oldControl, control));
  }
  ...
  public void setX(String newX)
  {
    ...
    x = newX;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__X, oldX, x));
  }
  ...
  public void setStart1(String newStart1)
  {
    ...
    start1 = newStart1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__START1, oldStart1, start1));
  }
  ...
  public void setEnd1(String newEnd1)
  {
    ...
    end1 = newEnd1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__END1, oldEnd1, end1));
  }
  ...
  public void setResponse(String newResponse)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__RESPONSE, oldResponse, response));
  }
  ...
  public void setY(String newY)
  {
    ...
    y = newY;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__Y, oldY, y));
  }
  ...
  public void setStart2(String newStart2)
  {
    ...
    start2 = newStart2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__START2, oldStart2, start2));
  }
  ...
  public void setEnd2(String newEnd2)
  {
    ...
    end2 = newEnd2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY1__END2, oldEnd2, end2));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.QUERY1__FACTOR:
        return getFactor();
      case HypoMethodPackage.QUERY1__CONTROL:
        return getControl();
      case HypoMethodPackage.QUERY1__X:
        return getX();
      case HypoMethodPackage.QUERY1__START1:
        return getStart1();
      case HypoMethodPackage.QUERY1__END1:
        return getEnd1();
      case HypoMethodPackage.QUERY1__RESPONSE:
        return getResponse();
      case HypoMethodPackage.QUERY1__Y:
        return getY();
      case HypoMethodPackage.QUERY1__START2:
        return getStart2();
      case HypoMethodPackage.QUERY1__END2:
        return getEnd2();
    }
