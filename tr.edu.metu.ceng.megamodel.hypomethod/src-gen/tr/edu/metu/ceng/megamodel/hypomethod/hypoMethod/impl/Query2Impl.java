 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query2Impl#getFunction1 <em>Function1</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query2Impl#getResponse1 <em>Response1</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query2Impl#getFactor1 <em>Factor1</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query2Impl#getFunction2 <em>Function2</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query2Impl#getResponse2 <em>Response2</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.Query2Impl#getFactor2 <em>Factor2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Query2Impl extends RelationalQueryImpl implements Query2
{
  ...
  {
    return HypoMethodPackage.Literals.QUERY2;
  }
  ...
  public void setFunction1(Function newFunction1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY2__FUNCTION1, oldFunction1, function1));
  }
  ...
  public void setResponse1(String newResponse1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY2__RESPONSE1, oldResponse1, response1));
  }
  ...
  public void setFactor1(String newFactor1)
  {
    ...
    factor1 = newFactor1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY2__FACTOR1, oldFactor1, factor1));
  }
  ...
  public void setFunction2(Function newFunction2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY2__FUNCTION2, oldFunction2, function2));
  }
  ...
  public void setResponse2(String newResponse2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY2__RESPONSE2, oldResponse2, response2));
  }
  ...
  public void setFactor2(String newFactor2)
  {
    ...
    factor2 = newFactor2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.QUERY2__FACTOR2, oldFactor2, factor2));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.QUERY2__FUNCTION1:
        return getFunction1();
      case HypoMethodPackage.QUERY2__RESPONSE1:
        return getResponse1();
      case HypoMethodPackage.QUERY2__FACTOR1:
        return getFactor1();
      case HypoMethodPackage.QUERY2__FUNCTION2:
        return getFunction2();
      case HypoMethodPackage.QUERY2__RESPONSE2:
        return getResponse2();
      case HypoMethodPackage.QUERY2__FACTOR2:
        return getFactor2();
    }
