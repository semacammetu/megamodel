 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.ValuesImpl#getFVal <em>FVal</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.ValuesImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.ValuesImpl#getValue <em>Value</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.ValuesImpl#getFvalue <em>Fvalue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValuesImpl extends MinimalEObjectImpl.Container implements Values
{
  ...
  {
    return HypoMethodPackage.Literals.VALUES;
  }
  ...
  public void setFVal(String newFVal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VALUES__FVAL, oldFVal, fVal));
  }
  ...
  public void setFunction(String newFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VALUES__FUNCTION, oldFunction, function));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VALUES__VALUE, oldValue, value));
  }
  ...
  public void setFvalue(String newFvalue)
  {
    ...
    fvalue = newFvalue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VALUES__FVALUE, oldFvalue, fvalue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HypoMethodPackage.VALUES__FVAL:
        return getFVal();
      case HypoMethodPackage.VALUES__FUNCTION:
        return getFunction();
      case HypoMethodPackage.VALUES__VALUE:
        return getValue();
      case HypoMethodPackage.VALUES__FVALUE:
        return getFvalue();
    }
