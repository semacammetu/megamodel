 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.VariablesImpl#getIndependentVariables <em>Independent Variables</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.VariablesImpl#getControlVariables <em>Control Variables</em>}</li>
 *   <li>{@link tr.edu.metu.ceng.megamodel.hypomethod.hypoMethod.impl.VariablesImpl#getDependentVariables <em>Dependent Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariablesImpl extends MinimalEObjectImpl.Container implements Variables
{
  ...
  {
    return HypoMethodPackage.Literals.VARIABLES;
  }
  ...
  public NotificationChain basicSetIndependentVariables(IndependentVariables newIndependentVariables, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VARIABLES__INDEPENDENT_VARIABLES, oldIndependentVariables, newIndependentVariables);
  ...
  public void setIndependentVariables(IndependentVariables newIndependentVariables)
  {
    if (newIndependentVariables != independentVariables)
    {
      ...
      if (independentVariables != null)
        msgs = ((InternalEObject)independentVariables).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.VARIABLES__INDEPENDENT_VARIABLES, null, msgs);
      if (newIndependentVariables != null)
        msgs = ((InternalEObject)newIndependentVariables).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.VARIABLES__INDEPENDENT_VARIABLES, null, msgs);
      msgs = basicSetIndependentVariables(newIndependentVariables, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VARIABLES__INDEPENDENT_VARIABLES, newIndependentVariables, newIndependentVariables));
  }
  ...
  public NotificationChain basicSetControlVariables(ControlVariables newControlVariables, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VARIABLES__CONTROL_VARIABLES, oldControlVariables, newControlVariables);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setControlVariables(ControlVariables newControlVariables)
  {
    if (newControlVariables != controlVariables)
    {
      ...
      if (controlVariables != null)
        msgs = ((InternalEObject)controlVariables).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.VARIABLES__CONTROL_VARIABLES, null, msgs);
      if (newControlVariables != null)
        msgs = ((InternalEObject)newControlVariables).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.VARIABLES__CONTROL_VARIABLES, null, msgs);
      msgs = basicSetControlVariables(newControlVariables, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VARIABLES__CONTROL_VARIABLES, newControlVariables, newControlVariables));
  }
  ...
  public NotificationChain basicSetDependentVariables(DependentVariables newDependentVariables, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VARIABLES__DEPENDENT_VARIABLES, oldDependentVariables, newDependentVariables);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDependentVariables(DependentVariables newDependentVariables)
  {
    if (newDependentVariables != dependentVariables)
    {
      ...
      if (dependentVariables != null)
        msgs = ((InternalEObject)dependentVariables).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.VARIABLES__DEPENDENT_VARIABLES, null, msgs);
      if (newDependentVariables != null)
        msgs = ((InternalEObject)newDependentVariables).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HypoMethodPackage.VARIABLES__DEPENDENT_VARIABLES, null, msgs);
      msgs = basicSetDependentVariables(newDependentVariables, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HypoMethodPackage.VARIABLES__DEPENDENT_VARIABLES, newDependentVariables, newDependentVariables));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HypoMethodPackage.VARIABLES__INDEPENDENT_VARIABLES:
        return basicSetIndependentVariables(null, msgs);
      case HypoMethodPackage.VARIABLES__CONTROL_VARIABLES:
        return basicSetControlVariables(null, msgs);
      case HypoMethodPackage.VARIABLES__DEPENDENT_VARIABLES:
