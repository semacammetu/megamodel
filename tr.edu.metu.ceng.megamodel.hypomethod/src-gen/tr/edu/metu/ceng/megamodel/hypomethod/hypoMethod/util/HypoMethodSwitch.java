 ...
 * @generated
 */
public class HypoMethodSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case HypoMethodPackage.EXPERIMENT_ONTOLOGY:
      {
      ...
      case HypoMethodPackage.TEMPORAL_PATTERN:
      {
      ...
      case HypoMethodPackage.RELATIONAL_QUERY:
      {
