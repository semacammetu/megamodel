...
public class HypoMethodSyntacticSequencer extends AbstractSyntacticSequencer {

	protected HypoMethodGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (HypoMethodGrammarAccess) access;
