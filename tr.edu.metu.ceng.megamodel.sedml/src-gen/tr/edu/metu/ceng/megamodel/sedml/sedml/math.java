 ...
 * </p>
 * <ul>
 *   <li>{@link tr.edu.metu.ceng.megamodel.sedml.sedml.math#getXlms <em>Xlms</em>}</li>
 * </ul>
 *
 * @see tr.edu.metu.ceng.megamodel.sedml.sedml.SedmlPackage#getmath()
 * @model
 * @generated
 */
public interface math extends EObject
{
   ...
   * @see #setXlms(String)
   * @see tr.edu.metu.ceng.megamodel.sedml.sedml.SedmlPackage#getmath_Xlms()
   * @model
   * @generated
   */
  String getXlms();
  ...
  /**
   * Sets the value of the '{@link tr.edu.metu.ceng.megamodel.sedml.sedml.math#getXlms <em>Xlms</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
